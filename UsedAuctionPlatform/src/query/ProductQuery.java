...
public interface ProductQuery {
	...
	String GET_PRODUCTBOX = "select img_seq, p.product_seq, nickname, title, category, start_price, price, p.address, end_date, state, count(bid_price)-1, max(bid_price), content "
			...
			+ "u.user_id = p.user_id "
			+ "group by img_seq, p.product_seq, nickname, title, category, start_price, price, p.address, end_date, state, start_date, content";
