...
<body>
  ...
  <div id="project_container">
    <div class="container-fulid">
          ...
          <tr>
            <th class="pointTxt">
              <div class="loPointFont" id="loPointFontDiv">
                <p class="pointFont" id="myPoint">
                  <%=request.getAttribute("point")%>
                </p>
              </div>
              <div class="cBeB">
        ...
        <div class="modal-dialog modal-dialog-centered justify-content-center modal-sm">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <input class="form-control form-control-lg" type="number" name="plusPoint" id="plusPoint">
            </div>
      ...
      <!-- Modal -->
      <div class="modal fade" id="exchangeModal" tabindex="-1" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered justify-content-center modal-sm">
          <div class="modal-content">
            ...
            <!-- <form action="controller?cmd=myPointAction" method="post"> -->
            <div class="modal-body">
              <input class="form-control form-control-lg" type="number" name="minusPoint" id="minusPoint">
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-secondary" id="modalBtn" data-bs-dismiss="modal">닫기</button>
      ...
      <!-- Modal -->
      <div class="modal fade" id="deleteMeModal" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true" data-bs-backdrop="false">
        <div class="modal-dialog modal-dialog-centered justify-content-center modal-sm">
          <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body" style="font-size: 11px;">
              <div class="form-check">
                <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault1"> <label
                  class="form-check-label" for="flexCheckDefault">
                  탈퇴 후 서비스 이용내역 확인이 불가능합니다. </label>
              </div>
              <div class="form-check">
                <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault2"> <label
                  class="form-check-label" for="flexCheckDefault">
                  탈퇴 후 충전한 포인트는 소멸됩니다. </label>
              </div>
              <div class="form-check">
                <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault4"> <label
                  class="form-check-label" for="flexCheckDefault">
                  탈퇴 후 동일한 아이디로 재가입이 불가능합니다. </label>
              </div>
            </div>
            <div class="modal-footer">
              <button type="button" class="stopSuicideBtn btn btn-secondary" data-bs-dismiss="modal">닫기</button>
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function () {
      $("#modalBtn.btn-primary").on("click", function () {
        ...
        $.post("controller?cmd=myPointAction", {
          pointAct: pointAct
        }, function (responseText) {
          var actPoint = parseInt(pointAct);
    ...
    function deleteMe() {
      ...
      if (checkDelete1.checked && checkDelete2.checked && checkDelete4.checked) {
        showMessage('회원 탈퇴가 완료됐습니다.');
        return true;
      } else {
        showMessage('주의사항을 확인해주세요.');
        return false;
      }
    }
  </script>
