...
<body>
  ...
  <div id="project_container">
    ...
    <div id="top">
      <img src="images/icon/previous.png" id="previous">
    ...
    <div class="container">
      ...
      <ul class="list-group w-100">
        ...
        <li class="list-group-item border-0 p-0">
          <div class="d-flex">
            <img src="images/product1/product1-img1.jpg" class="img-fluid">
            <div class="ms-1">
        ...
        <li class="list-group-item border-0 p-0">
          <div class="d-flex">
            <img src="images/product2/product2-img1.jpg" class="img-fluid">
            <div class="ms-1">
              <div class="card-text d-flex">
